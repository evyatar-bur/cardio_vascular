...
%% system parameters:
% Time parameters
HR           = 60 + IDs... ; % [BPM] % 60 + sum of last digits from all members
dt           = 5e-4        ; % [sec]
Heart_cycles = 20          ; % total heart cycles
N_per_cycle      = ...     ; % number of steps per heart cycle
  
% Heart parameters
V0           = 15  ; % [ml] V0 for Plv calculation
Emax         = 2.0 ; % contractility
N_Systole    = ... ; % number of points per ventricle Systole
N_Diastole   = ... ; % number of points per ventricle Diastole
E            = ... ; % Heart Elasticity: combine Systole (elasticity function) & Diastole (uniform value) 
